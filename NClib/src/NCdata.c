...
int NCdataGetXDimId(int ncid) {
    ...
    if ((nc_inq_dimid(ncid, NCnameDNCoord, &dimid) == NC_NOERR) ||
        ...
        (nc_inq_dimid(ncid, NCnameDNLongitude, &dimid) == NC_NOERR))
        return (dimid);
    return (NCfailed);
}
...
int NCdataGetXVarId(int ncid) {
    ...
    if ((nc_inq_varid(ncid, NCnameDNXCoord, &varid) == NC_NOERR) ||
        ...
        (nc_inq_varid(ncid, NCnameDNLongitude, &varid) == NC_NOERR))
        return (varid);
    return (NCfailed);
}
...
int NCdataGetYDimId(int ncid) {
    ...
    if ((nc_inq_dimid(ncid, NCnameDNCoord, &dimid) == NC_NOERR) ||
        ...
        (nc_inq_dimid(ncid, NCnameDNLatitude, &dimid) == NC_NOERR))
        return (dimid);
    return (NCfailed);
}
...
int NCdataGetYVarId(int ncid) {
    ...
    if ((nc_inq_varid(ncid, NCnameDNYCoord, &varid) == NC_NOERR) ||
        ...
        (nc_inq_varid(ncid, NCnameDNLatitude, &varid) == NC_NOERR))
        return (varid);
    return (NCfailed);
}
