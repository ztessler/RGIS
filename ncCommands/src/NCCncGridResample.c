...
int main(int argc, char *argv[]) {
    ...
    if ((dataType = NCdataGetType(sncid)) == NCtypeUndefined) {
        nc_close(sncid);
        return (CMfailed);
    }
    ...
    if ((title == (char *) NULL) &&
        ((title = NCdataGetTextAttribute(sncid, NC_GLOBAL, NCnameGATitle)) == (char *) NULL))
        title = "Undefined";
    if ((subject == (char *) NULL) &&
        ((subject = NCdataGetTextAttribute(sncid, NC_GLOBAL, NCnameGASubject)) == (char *) NULL))
        subject = "Undefined";
    if ((domain == (char *) NULL) &&
        ((domain = NCdataGetTextAttribute(sncid, NC_GLOBAL, NCnameGADomain)) == (char *) NULL))
        domain = "Undefined";
