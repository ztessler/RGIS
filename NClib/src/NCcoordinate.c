...
void NCcoordinateAdd(NCcoordinate_t *coord0, NCcoordinate_t *coord1, NCcoordinate_t *result) {
    if ((coord0 == (NCcoordinate_t *) NULL) || (coord1 == (NCcoordinate_t *) NULL) ||
        (result == (NCcoordinate_t *) NULL)) {
        CMmsgPrint(CMmsgAppError, "Null Coordinate Pointer in: %s %d", __FILE__, __LINE__);
        return;
    }
